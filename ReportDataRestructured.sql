CREATE TABLE DMHP.Reportdata_restructured as
	SELECT ReportId,StateId,DistrictId,TalukaId,MncHospitalId,PhcId,ChcId,1 as FacilityType,FacilityId,ReportingMonthyear,'old' as VisitType,'M' as Gender,'IP' as ConsultType,
	...
	SELECT ReportId,StateId,DistrictId,TalukaId,MncHospitalId,PhcId,ChcId,1 as FacilityType,FacilityId,ReportingMonthyear,'old' as VisitType,'F' as Gender,'IP' as ConsultType,
	...
	SELECT ReportId,StateId,DistrictId,TalukaId,MncHospitalId,PhcId,ChcId,1 as FacilityType,FacilityId,ReportingMonthyear,'new' as VisitType,'M' as Gender,'IP' as ConsultType,
	...
	SELECT ReportId,StateId,DistrictId,TalukaId,MncHospitalId,PhcId,ChcId,1 as FacilityType,FacilityId,ReportingMonthyear,'new' as VisitType,'F' as Gender,'IP' as ConsultType,
	...
	SELECT ReportId,StateId,DistrictId,TalukaId,MncHospitalId,PhcId,ChcId,1 as FacilityType,FacilityId,ReportingMonthyear,'N' as VisitType,'N' as Gender,'OP' as ConsultType,
