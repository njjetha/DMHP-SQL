CREATE TABLE DMHP.Reportdata_restructured as
	SELECT ReportId,StateId,DistrictId,TalukaId,MncHospitalId,1 as FacilityType,FacilityId,ReportingMonthyear,'old' as VisitType,'M' as Gender,'IP' as ConsultType,
	...
	SELECT ReportId,StateId,DistrictId,TalukaId,MncHospitalId,1 as FacilityType,FacilityId,ReportingMonthyear,'old' as VisitType,'F' as Gender,'IP' as ConsultType,
	...
	SELECT ReportId,StateId,DistrictId,TalukaId,MncHospitalId,1 as FacilityType,FacilityId,ReportingMonthyear,'new' as VisitType,'M' as Gender,'IP' as ConsultType,
	...
	SELECT ReportId,StateId,DistrictId,TalukaId,MncHospitalId,1 as FacilityType,FacilityId,ReportingMonthyear,'new' as VisitType,'F' as Gender,'IP' as ConsultType,
	...
	SELECT ReportId,StateId,DistrictId,TalukaId,MncHospitalId,1 as FacilityType,FacilityId,ReportingMonthyear,'N' as VisitType,'N' as Gender,'OP' as ConsultType,
        ...
        InPatient_9 as BehaviouralDisorders,InPatient_10 as EmotionalDisorders,InPatient_1 as PsychiatricDisorders,
        InPatient_5 as Others,InPatient_4 as Referred,InPatient_1+InPatient_2+InPatient_6+InPatient_7+InPatient_3+InPatient_11+
        InPatient_8+InPatient_9+InPatient_10+InPatient_1+InPatient_5+InPatient_4 as TotalPatient from DMHP.tbl_reportdata;